...
//
// ĐANG TRONG QUÁ TRÌNH CHẺ NHỎ (§4.1). File này từng là 2.478 dòng gộp 23 hàm thuộc
// bảy nhóm nghiệp vụ khác nhau. Đã tách:
//   - Nhóm chia sẻ (5 hàm) -> examSetShare.service.js   [Wave 4.1, bước 1/7]
// Còn lại 18 hàm, sẽ tách tiếp theo thứ tự an toàn §4.1: version, import, metrics,
// question, access — phần sót lại cuối cùng mới là core thật sự.
