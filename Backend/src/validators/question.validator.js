...
export const updateQuestionValidation = [
  body("content").optional().isString().trim().notEmpty().withMessage("content không được để trống"),
  ...
  body("difficulty").optional().isIn(["EASY", "MEDIUM", "HARD"]).withMessage("difficulty không hợp lệ"),
