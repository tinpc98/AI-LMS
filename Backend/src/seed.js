...
async function seedDatabase() {
    try {
        ...
        try {
            ...
            if (err.code !== 26) { // Code 26 là collection không tồn tại, có thể bỏ qua
        ...
        const questionsData = [];
        const topics = ["Grammar & Vocabulary", "OOP Concepts", "MongoDB Indexing", "React State Management", "Algorithm Complexity"];
        ...
        for (let i = 1; i <= 300; i++) {
            ...
            questionsData.push({
                ...
                correctAnswer: isMCQ ? getRandomItem(["Lựa chọn A", "Lựa chọn B", "Lựa chọn C", "Lựa chọn D"]) : "",
