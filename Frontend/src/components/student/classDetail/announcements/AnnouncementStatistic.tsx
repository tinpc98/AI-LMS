...
export const AnnouncementStatistic: React.FC<AnnouncementStatisticProps> = React.memo(({ stats }) => {
  return (
    <Row gutter={[12, 12]} style={{ marginBottom: 24 }}>
      ...
      <Col xs={12} sm={6}>
        <Card bordered={false} styles={{ body: { padding: "12px 16px" } }} style={{ borderRadius: 12, backgroundColor: "#fff2e8" }}>
          <Statistic
