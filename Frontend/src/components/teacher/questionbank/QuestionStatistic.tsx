      ...
      <Row gutter={[16, 16]}>
        <Col xs={12} sm={8} md={5}>
          <div style={{ backgroundColor: "rgba(255,255,255,0.15)", padding: "12px 16px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.25)" }}>
            <Statistic
              title={<Text style={{ color: "rgba(255,255,255,0.85)", fontSize: 12 }}>Tổng số câu hỏi</Text>}
              value={stats.total}
        ...
        <Col xs={12} sm={8} md={5}>
          <div style={{ backgroundColor: "rgba(255,255,255,0.15)", padding: "12px 16px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.25)" }}>
            <Statistic
              title={<Text style={{ color: "rgba(255,255,255,0.85)", fontSize: 12 }}>🔵 Trắc nghiệm (MCQ)</Text>}
        ...
        <Col xs={12} sm={8} md={5}>
          <div style={{ backgroundColor: "rgba(255,255,255,0.15)", padding: "12px 16px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.25)" }}>
            <Statistic
              title={<Text style={{ color: "rgba(255,255,255,0.85)", fontSize: 12 }}>🟣 Tự luận (ESSAY)</Text>}
        ...
        <Col xs={12} sm={8} md={9}>
          <div style={{ backgroundColor: "rgba(255,255,255,0.15)", padding: "12px 16px", borderRadius: 12, border: "1px solid rgba(255,255,255,0.25)" }}>
            <Text style={{ color: "rgba(255,255,255,0.85)", fontSize: 12, display: "block", marginBottom: 4 }}>
              Cơ cấu độ khó: Dễ ({stats.easyCount}) | Vừa ({stats.mediumCount}) | Khó ({stats.hardCount})
            </Text>
            <Progress
              percent={stats.total > 0 ? Math.round((stats.easyCount / stats.total) * 100) : 0}
              success={{ percent: stats.total > 0 ? Math.round((stats.mediumCount / stats.total) * 100) : 0 }}
              strokeColor="#b7eb8f"
