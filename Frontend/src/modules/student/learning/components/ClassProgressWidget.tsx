...
export const ClassProgressWidget: React.FC<ClassProgressWidgetProps> = React.memo(({ classProgress }) => {
  return (
    <Card
      title={
        <span style={{ fontSize: 15, fontWeight: 700 }}>
          <BookOutlined style={{ color: "#1890ff", marginRight: 6 }} /> Tiến độ học tập từng môn ({classProgress.length})
        </span>
      }
