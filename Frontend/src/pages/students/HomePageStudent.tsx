    ...
    (e: React.FormEvent) => {
      ...
      const uniqueId =
        typeof crypto.randomUUID === "function"
          ? crypto.randomUUID()
          : "t-" + Date.now() + Math.random().toString(36).substr(2, 4);
    ...
    (text: string) => {
      ...
      aiTimerRef.current = setTimeout(() => {
        ...
        if (query.includes("chao") || query.includes("hello")) {
          ...
          response =
            "Hiện tại GPA của bạn đang là **8.4**. Để nâng lên **8.8**, hãy luyện tập thêm phần *Giải thuật tìm kiếm* (hiện mới đạt 33%).";
        }
              ...
              <div className="lms-card">
                ...
                <div className="lms-ai-cards-grid">
                  ...
                  <div
                    onClick={() =>
                      triggerToast(
                        "Tính năng tóm tắt tài liệu đang giả lập trong AI Chat Panel. Vui lòng mở chat!",
                        "info",
                      )
                    }
                    className="lms-ai-card"
                  >
                    <div
                      className="lms-ai-card-icon"
                      style={{
                        backgroundColor: "var(--lms-sky-light)",
                        color: "var(--lms-sky)",
                      }}
                    >
                      <span className="material-symbols-outlined">
