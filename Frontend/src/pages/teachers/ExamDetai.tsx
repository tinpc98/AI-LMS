          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <div className="flex items-center gap-3">
                <h2 className="font-headline-lg text-headline-lg text-on-surface">Trần Quốc Quân</h2>
          ...
          <div className="flex flex-col items-end gap-2">
            <div className="flex items-center gap-3 ai-shimmer p-[2px] rounded-full">
              <div className="bg-surface-container-lowest px-4 py-1 rounded-full flex items-center gap-2">
                ...
                <span className="font-label-md text-primary font-bold">Chấm điểm tự động</span>
              </div>
            </div>
            <div className="text-right">
              ...
              <p className="font-label-md text-green-600 font-bold uppercase tracking-wider mt-1">Vượt mục tiêu</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex-[1.5] flex flex-col bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden shadow-sm">
          <div className="p-6 border-b border-outline-variant flex justify-between items-center bg-surface-container-low">
            ...
            <div className="flex gap-2">
              <span className="bg-green-100 text-green-700 px-3 py-1 rounded-lg text-sm font-medium">8 Đúng</span>
              <span className="bg-red-100 text-red-700 px-3 py-1 rounded-lg text-sm font-medium">2 Sai</span>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-label-md text-primary font-bold">Câu 1: Cấu trúc dữ liệu Stack</span>
                <span className="bg-green-50 text-green-700 px-3 py-1 rounded-full text-[12px] font-bold">
                  1.0 / 1.0 Điểm
                </span>
              </div>
              <p className="font-body-md text-on-surface">
                Giải thuật nào sau đây sử dụng nguyên tắc LIFO (Last In First Out)?
              </p>
              <div className="grid grid-cols-1 gap-2">
                <div className="p-4 border border-outline-variant rounded-lg font-body-md">A. Hàng đợi (Queue)</div>
                ...
                <div className="p-4 border border-outline-variant rounded-lg font-body-md">D. Cây nhị phân</div>
              </div>
              <div className="bg-surface-container-low p-3 rounded-lg flex gap-2 items-start">
                <span className="material-symbols-outlined text-primary text-[20px]">info</span>
                <p className="text-sm text-on-surface-variant italic">
                  AI Nhận xét: Học sinh nắm vững kiến thức cơ bản về cấu trúc dữ liệu tuyến tính.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-label-md text-primary font-bold">Câu 2: Độ phức tạp thuật toán</span>
                <span className="bg-red-50 text-red-700 px-3 py-1 rounded-full text-[12px] font-bold">
                  0.0 / 1.0 Điểm
                </span>
              </div>
              <p className="font-body-md text-on-surface">
                Độ phức tạp thời gian của thuật toán QuickSort trong trường hợp xấu nhất là gì?
              </p>
              <div className="grid grid-cols-1 gap-2">
                <div className="p-4 border border-outline-variant rounded-lg font-body-md">A. O(n log n)</div>
                ...
                <div className="p-4 border border-outline-variant rounded-lg font-body-md">D. O(log n)</div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-start">
                <span className="font-label-md text-primary font-bold">Câu 3: Triển khai thuật toán (Code)</span>
                <span className="bg-green-50 text-green-700 px-3 py-1 rounded-full text-[12px] font-bold">
                  2.5 / 2.5 Điểm
                </span>
              </div>
              <p className="font-body-md text-on-surface">Viết hàm tìm kiếm nhị phân trên một mảng đã sắp xếp.</p>
              <div className="bg-inverse-surface rounded-xl p-6 font-code-sm text-surface overflow-x-auto shadow-inner">
                <pre className="text-[#c3c0ff]">
                  <span className="text-secondary-fixed">int</span> binarySearch(
                  <span className="text-secondary-fixed">int</span> arr[],{" "}
                  <span className="text-secondary-fixed">int</span> n, <span className="text-secondary-fixed">int</span>{" "}
                  x) {"{\n"}
                  {"    "}
                  <span className="text-secondary-fixed">int</span> left = <span className="text-primary-fixed">0</span>
                  , right = n - <span className="text-primary-fixed">1</span>;{"\n"}
                  {"    "}
                  <span className="text-on-secondary-container">// AI marked: Perfect implementation</span>
                  {"\n"}
                  {"    "}
                  <span className="text-secondary-fixed">while</span> (left &lt;= right) {"{\n"}
                  {"        "}
                  <span className="text-secondary-fixed">int</span> mid = left + (right - left) /{" "}
                  <span className="text-primary-fixed">2</span>;{"\n"}
                  {"        "}
                  <span className="text-secondary-fixed">if</span> (arr[mid] == x){" "}
                  <span className="text-secondary-fixed">return</span> mid;
                  {"\n"}
                  {"        "}
                  <span className="text-secondary-fixed">if</span> (arr[mid] &lt; x) left = mid +{" "}
                  ...
                  {"\n"}
                  {"    "}
                  <span className="text-secondary-fixed">return</span> -<span className="text-primary-fixed">1</span>;
                  {"\n"}
                  {"}"}
                </pre>
              </div>
        ...
        <div className="flex-1 flex flex-col gap-gutter">
          ...
          <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-6 shadow-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-headline-md text-headline-md">Chỉ số tin cậy</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-surface-container-low p-4 rounded-xl text-center">
                ...
                <p className="text-[12px] text-on-surface-variant uppercase tracking-tight">Cảnh báo</p>
              </div>
              <div className="bg-surface-container-low p-4 rounded-xl text-center">
                <p className="text-[20px] font-bold text-on-surface">0</p>
                <p className="text-[12px] text-on-surface-variant uppercase tracking-tight">Vi phạm nặng</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 bg-surface-container-lowest border border-outline-variant rounded-xl flex flex-col overflow-hidden shadow-sm">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 custom-scrollbar relative">
              ...
              <div className="relative flex gap-4 pl-10 hover:translate-x-1 transition-transform duration-200 ease-out">
                ...
                <div className="flex-1 bg-surface-container-low p-3 rounded-xl border border-outline-variant">
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-code-sm text-primary font-bold">14:20:05</span>
                    <span className="bg-secondary-container text-on-secondary-container px-2 py-0.5 rounded text-[10px] uppercase">
                      Cảnh báo nhẹ
                    </span>
                  </div>
                  <p className="font-label-md font-bold">Chuyển tab trình duyệt</p>
              ...
              <div className="relative flex gap-4 pl-10 hover:translate-x-1 transition-transform duration-200 ease-out">
                ...
                <div className="flex-1 bg-surface-container-low p-3 rounded-xl border border-outline-variant">
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-code-sm text-secondary font-bold">14:25:30</span>
                  </div>
              ...
              <div className="relative flex gap-4 pl-10 hover:translate-x-1 transition-transform duration-200 ease-out">
                ...
                <div className="flex-1 bg-error-container text-on-error-container p-3 rounded-xl border border-error/20">
                  ...
                  <p className="text-sm opacity-90 mb-2">
                    Camera phát hiện có thêm 01 người xuất hiện trong khung hình phía sau SV.
                  </p>
              ...
              <div className="relative flex gap-4 pl-10 opacity-60 hover:translate-x-1 transition-transform duration-200 ease-out">
                ...
                <div className="flex-1 bg-surface-container-low p-3 rounded-xl">
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-code-sm text-outline font-bold">15:02:42</span>
                  </div>
                  <p className="font-label-md font-bold">Hoàn thành bài thi</p>
                  <p className="text-sm text-on-surface-variant">SV nộp bài thủ công.</p>
                </div>
              </div>
            </div>
