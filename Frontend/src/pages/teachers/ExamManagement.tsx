    ...
    <main className="ml-[280px] pt-16 min-h-screen">
      <div className="max-w-max-content-width mx-auto p-margin-desktop">
        ...
        <div className="flex justify-between items-end mb-8">
          <div>
            <h1 className="text-headline-lg font-headline-lg text-on-surface">Quản lý kỳ thi</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-gutter mb-10">
          <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 transition-all group">
            ...
            <p className="text-label-md text-on-surface-variant uppercase tracking-wider mb-1">Tổng số kỳ thi</p>
            <h3 className="text-headline-md font-bold text-on-surface">48</h3>
          </div>

          <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 transition-all group">
            <div className="flex justify-between items-start mb-4">
              <span className="p-2 bg-green-100 text-green-700 rounded-lg material-symbols-outlined" data-icon="pulse">
                pause
              </span>
              <span className="text-label-md text-green-600 font-bold">Hoạt động</span>
            </div>
            <p className="text-label-md text-on-surface-variant uppercase tracking-wider mb-1">Đang diễn ra</p>
          ...
          <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 transition-all group">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-label-md text-blue-600 font-bold">Sắp tới</span>
            </div>
            <p className="text-label-md text-on-surface-variant uppercase tracking-wider mb-1">Sắp diễn ra</p>
          ...
          <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 transition-all group">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-label-md text-on-surface-variant font-bold">Lưu trữ</span>
            </div>
            <p className="text-label-md text-on-surface-variant uppercase tracking-wider mb-1">Đã hoàn thành</p>
        ...
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant p-6 mb-6">
          <div className="flex flex-wrap items-center gap-4">
            <div className="flex-1 min-w-[200px]">
              <label className="block text-label-md font-bold text-on-surface mb-2">Học kỳ</label>
            ...
            <div className="flex-1 min-w-[200px]">
              <label className="block text-label-md font-bold text-on-surface mb-2">Lớp học</label>
              <select className="w-full border-outline-variant rounded-lg text-body-sm focus:ring-primary">
        ...
        <div className="bg-surface-container-lowest rounded-xl border border-outline-variant overflow-hidden">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-surface-container text-on-surface-variant">
                <th className="px-6 py-4 font-label-md text-label-md border-b border-outline-variant">Tên kỳ thi</th>
                <th className="px-6 py-4 font-label-md text-label-md border-b border-outline-variant">Lớp</th>
                <th className="px-6 py-4 font-label-md text-label-md border-b border-outline-variant">Trạng thái</th>
              ...
              <tr className="hover:bg-surface-container-low transition-colors group cursor-pointer">
                <td className="px-6 py-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-on-surface">Kiểm tra giữa kỳ I - Toán 10</p>
                      <p className="text-body-sm text-on-surface-variant">ID: EXAM-2023-001</p>
                    </div>
                  </div>
                </td>
                ...
                <td className="px-6 py-5 text-body-sm text-on-surface-variant">08:00, 15/10/2023</td>
              ...
              <tr className="hover:bg-surface-container-low transition-colors group cursor-pointer">
                <td className="px-6 py-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-on-surface">Khảo sát năng lực Tiếng Anh đầu năm</p>
                      <p className="text-body-sm text-on-surface-variant">ID: EXAM-2023-002</p>
                    </div>
                  </div>
                </td>
                ...
                <td className="px-6 py-5 text-body-sm text-on-surface-variant">09:30, 01/09/2023</td>
                <td className="px-6 py-5 text-center font-code-sm">450 / 450</td>
                <td className="px-6 py-5 text-right">
                  <div className="flex justify-end gap-2">
                    <button
                      className="p-2 text-on-surface-variant hover:text-primary hover:bg-primary-fixed rounded-lg transition-all"
              ...
              <tr className="hover:bg-surface-container-low transition-colors group cursor-pointer">
                <td className="px-6 py-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-on-surface">Kiểm tra 15p Chương 1 - Lý 11</p>
                      <p className="text-body-sm text-on-surface-variant">ID: EXAM-2023-005</p>
                    </div>
                  </div>
                </td>
                ...
                <td className="px-6 py-5 text-body-sm text-on-surface-variant">--/--/----</td>
                ...
                <td className="px-6 py-5 text-right">
                  <div className="flex justify-end gap-2">
                    <button
                      ...
                      title="Xem báo cáo"
                    >
                      <span className="material-symbols-outlined opacity-30" data-icon="bar_chart">
                        bar_chart
                      </span>
                    </button>
                    <button
              ...
              <tr className="hover:bg-surface-container-low transition-colors group cursor-pointer">
                <td className="px-6 py-5">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-10 bg-green-500 rounded-full"></div>
                    <div>
                      <p className="font-bold text-on-surface">Thi thử THPT Quốc gia đợt 1</p>
                      <p className="text-body-sm text-on-surface-variant">ID: EXAM-2023-009</p>
                    </div>
                  </div>
                </td>
                ...
                <td className="px-6 py-5 text-body-sm text-on-surface-variant">07:30, 20/10/2023</td>
                <td className="px-6 py-5 text-center font-code-sm">512 / 515</td>
                <td className="px-6 py-5 text-right">
                  <div className="flex justify-end gap-2">
                    <button
                      className="p-2 text-on-surface-variant hover:text-primary hover:bg-primary-fixed rounded-lg transition-all"
          ...
          <div className="px-6 py-4 bg-surface-container flex justify-between items-center">
            <p className="text-body-sm text-on-surface-variant">Hiển thị 1-10 trong số 48 kỳ thi</p>
            <div className="flex gap-2">
              ...
              <button className="px-3 py-1 rounded hover:bg-surface-container-high transition-colors">2</button>
              <button className="px-3 py-1 rounded hover:bg-surface-container-high transition-colors">3</button>
              <button className="p-2 rounded border border-outline-variant hover:bg-surface-bright transition-colors">
        ...
        <footer className="mt-12 text-center text-body-sm text-on-surface-variant border-t border-outline-variant pt-6">
          <p>© 2024 AI-LMS Portal - Academic Exam Management Module. All Rights Reserved.</p>
        </footer>
      </div>
    </main>
  );
