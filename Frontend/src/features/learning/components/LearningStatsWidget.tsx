      ...
      <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
        <Col xs={12} sm={6}>
          <Card
            ...
            style={{ borderRadius: 16, backgroundColor: "#fff7e6" }}
          >
            <Statistic
            ...
            />
            <Progress
              percent={Math.round((statistics.gpa / 10) * 100)}
              showInfo={false}
              strokeColor="#fa8c16"
              size="small"
              style={{ marginTop: 8 }}
        ...
        <Col xs={12} sm={6}>
          <Card
            bordered={false}
            styles={{ body: { padding: 16 } }}
            style={{ borderRadius: 16, backgroundColor: "#f6ffed" }}
          >
            <Statistic
        ...
        <Col xs={12} sm={6}>
          <Card
            bordered={false}
            styles={{ body: { padding: 16 } }}
            style={{ borderRadius: 16, backgroundColor: "#e6f7ff" }}
          >
            <Statistic
            ...
            />
            <Progress
              percent={statistics.assignmentCompletionRate}
              showInfo={false}
              strokeColor="#1890ff"
              size="small"
              style={{ marginTop: 8 }}
        ...
        <Col xs={12} sm={6}>
          <Card
            bordered={false}
            styles={{ body: { padding: 16 } }}
            style={{ borderRadius: 16, backgroundColor: "#f9f0ff" }}
          >
            <Statistic
            ...
            />
            <Progress
              percent={statistics.examPerformanceRate}
              showInfo={false}
              strokeColor="#722ed1"
              size="small"
              style={{ marginTop: 8 }}
