...
const ClassFormModal = forwardRef<ClassFormModalHandle, ClassFormModalProps>(
        ...
        <Form form={form} layout="vertical" onFinish={handleFinish}>
          <Form.Item
            ...
            rules={[
              ...
              { whitespace: true, message: "Class name is required" },
            ]}
          >
          ...
          <Form.Item
            name="classCode"
            label="Class Code"
            rules={[{ required: true, message: "Class code is required" }]}
          >
          ...
          <Form.Item
            name="learningMode"
            label="Learning Mode"
            rules={[{ required: true, message: "Learning mode is required" }]}
          >
            <Select
              options={[
          ...
          <Form.Item
            ...
            label="Max Students"
            rules={[
              { required: true, message: "Max students is required" },
