      ...
      {classRecord ? (
        <Descriptions column={1} bordered>
          ...
          <Descriptions.Item label="Course">
            {courseOptions.find((item) => item.id === classRecord.courseId)?.label ||
              classRecord.courseId}
          </Descriptions.Item>
          <Descriptions.Item label="Teacher">
            {classRecord.teacher ? classRecord.teacher.fullName : "—"}
          </Descriptions.Item>
          ...
          <Descriptions.Item label="Meeting Room ID">
            {classRecord.meetingRoomId || "—"}
          </Descriptions.Item>
          ...
          <Descriptions.Item label="Enrollment">
            {classRecord.isEnrollmentOpen ? "Open" : "Closed"}
          </Descriptions.Item>
          ...
          <Descriptions.Item label="Created At">
            {new Date(classRecord.createdAt).toLocaleString("vi-VN")}
          </Descriptions.Item>
        </Descriptions>
      ) : null}
    </Drawer>
