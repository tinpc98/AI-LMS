...
export const TeacherClassOverviewTab: React.FC<TeacherClassOverviewTabProps> = React.memo(
  ({ classInfo }) => {
          ...
          >
            {Array.isArray(classInfo.resources) && classInfo.resources.length > 0 ? (
              ...
              <Empty
                ...
                description="Chưa có tài liệu đính kèm nào trong lớp học."
              />
            )}
          </Card>
        </Col>
