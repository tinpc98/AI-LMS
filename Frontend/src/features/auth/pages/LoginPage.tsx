        ...
        <div className="bg-slate-900/60 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-white/10">
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onValid, onError)}>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center px-0.5">
                ...
                <span
                  className="text-[11px] font-medium text-slate-500 cursor-not-allowed"
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              disabled
              title="Tính năng đang được phát triển"
              className="flex items-center justify-center gap-2 bg-slate-950/40 border border-white/10 rounded-xl py-2 opacity-50 cursor-not-allowed"
            >
