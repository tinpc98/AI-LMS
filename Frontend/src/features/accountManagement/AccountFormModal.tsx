...
const AccountFormModal = forwardRef<AccountFormModalHandle, AccountFormModalProps>(function AccountFormModal(
    ...
    >
      <Form form={form} layout="vertical" onFinish={handleFinish}>
        ...
        <Form.Item
          name="fullName"
          label="Full Name"
          rules={[{ required: true, message: "Full name is required" }, { whitespace: true, message: "Full name is required" }]}
        >
