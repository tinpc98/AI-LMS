  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end">
          ...
          <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4 bg-slate-50 custom-scrollbar">
            {initStatus === "error" ? (
              <div className="flex flex-col items-center justify-center h-full text-gray-500">
                ...
                <p className="text-sm font-medium text-center px-4 mb-4 text-red-500">
                  {error || "Không thể khởi tạo trợ lý AI."}
                </p>
                <button
                  onClick={initSession}
              ...
              <div className="flex flex-col items-center justify-center h-full text-gray-400">
                <span
                  className="material-symbols-outlined text-5xl mb-3 opacity-60 animate-pulse"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
                  robot_2
                </span>
                <p className="text-sm font-medium text-center px-4 animate-pulse">
              ...
              <div className="flex flex-col items-center justify-center h-full text-gray-400">
                <span
                  className="material-symbols-outlined text-5xl mb-3 opacity-60"
                  style={{ fontVariationSettings: "'FILL' 1" }}
                >
                  robot_2
                </span>
                ...
                <div className="mt-6 flex flex-col gap-2 w-full">
                  <button
                    onClick={() => setInputText("Giải thích tiến độ học tập của tôi")}
                    className="text-xs bg-white border border-gray-200 p-2 rounded-lg hover:border-primary hover:text-primary transition-colors text-left text-gray-600"
                  >
                    💡 Giải thích tiến độ học tập của tôi
                  </button>
                  <button
                    onClick={() => setInputText("Tôi nên học gì hôm nay?")}
                    className="text-xs bg-white border border-gray-200 p-2 rounded-lg hover:border-primary hover:text-primary transition-colors text-left text-gray-600"
                  >
              ...
              messages.map((msg, idx) => (
                ...
                >
                  <div
                    className={`px-4 py-2.5 rounded-2xl text-[14px] shadow-sm ${msg.role === "user" ? "bg-primary text-white rounded-br-sm" : "bg-white border border-outline-variant text-gray-800 rounded-bl-sm"}`}
                  >
          ...
          <div className="p-4 bg-white border-t border-outline-variant">
            ...
            <div className="text-center mt-2">
              <span className="text-[10px] text-gray-400">
                Trợ lý AI có thể trả lời sai, vui lòng kiểm chứng.
              </span>
            </div>
          </div>
        </div>
      ...
      {!isOpen && (
        ...
        >
          <span
            className="material-symbols-outlined text-3xl group-hover:animate-pulse"
            style={{ fontVariationSettings: "'FILL' 1" }}
          >
            auto_awesome
          </span>
