      ...
      <main className="md:ml-[280px] p-margin-desktop max-w-max-content-width mx-auto">
          ...
          <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant hover:border-primary/30 hover:shadow-md transition-all group overflow-hidden">
            ...
            <div className="flex items-baseline gap-2 mt-2">
              ...
              <span className="flex items-center gap-1">
                ...
                <span className="font-body-sm text-emerald-600">
                  Trực tuyến
                </span>
              </span>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <button className="ai-glow group relative flex items-center justify-between p-8 bg-primary text-on-primary rounded-2xl overflow-hidden transition-all hover:scale-[1.02] shadow-lg">
            ...
            <button className="ai-glow group relative flex items-center justify-between p-8 bg-secondary text-on-secondary rounded-2xl overflow-hidden transition-all hover:scale-[1.02] shadow-lg">
              <div className="z-10 text-left">
                <p className="font-headline-md text-headline-md mb-1">
                  Tạo bài tập
                </p>
            ...
            <button className="ai-glow group relative flex items-center justify-between p-8 bg-tertiary-container text-on-tertiary-container rounded-2xl overflow-hidden transition-all hover:scale-[1.02] shadow-lg">
              <div className="z-10 text-left">
                <p className="font-headline-md text-headline-md mb-1">
                  Tạo đề thi
                </p>
        ...
        {/* <!-- Active ClassnclassNamees Table --> */}
        <section className="bg-surface-container-lowest rounded-xl border border-outline-variant overflow-hidden">
              ...
              <tbody className="divide-y divide-outline-variant">
                <tr className="hover:bg-surface-container-low transition-colors group">
                  ...
                  <td className="px-6 py-5 text-right">
                    <button className="px-4 py-2 bg-secondary/10 text-secondary hover:bg-secondary hover:text-on-secondary rounded-lg font-label-md text-label-md transition-all">
                      Điểm danh
                    </button>
                  </td>
                </tr>
          ...
          <div className="px-6 py-4 bg-surface-container-low/30 border-t border-outline-variant flex justify-center">
            <nav className="flex items-center gap-2">
              ...
              <button className="w-8 h-8 flex items-center justify-center bg-primary text-on-primary rounded-lg font-bold">
                1
              </button>
              <button className="w-8 h-8 flex items-center justify-center hover:bg-surface-container rounded-lg">
                2
              </button>
              <button className="w-8 h-8 flex items-center justify-center hover:bg-surface-container rounded-lg">
                3
